...
{    
    ...
    self.chromecastDeviceController = [[STChromecastDeviceController alloc] init];
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    [self.chromecastDeviceController sendMessage:@"stop"];
    [self.chromecastDeviceController disconnectFromDevice];
}
